...
export const INSIGHTS: AIInsight[] = [
  // ─── 1. Featured — portfolio performance ──────────────────
  {
    ...
    action: { label: 'Reel analiz sayfasına git', tabTarget: 'inflation' },
  ...
  // ─── 2. TCMB rate decision ─────────────────────────────────
  {
    ...
    action: { label: 'Para piyasası fonlarını gör', tabTarget: 'explorer' },
    timestamp: '2026-05-19',
    readTime: 3,
  },
  ...
  // ─── 3. Gold opportunity ───────────────────────────────────
  {
    ...
    action: { label: 'Altın fonlarını incele', tabTarget: 'explorer' },
    timestamp: '2026-05-19',
    readTime: 2,
  },
  ...
  // ─── 6. Rebalancing suggestion ────────────────────────────
  {
    ...
    action: { label: 'Dağılım görünümüne git', tabTarget: 'portfolio' },
    timestamp: '2026-05-19',
    readTime: 2,
  },
  ...
  // ─── 7. Fund alert ────────────────────────────────────────
  {
    ...
    action: { label: 'GAF detayına git', tabTarget: 'explorer' },
    timestamp: '2026-05-19',
    readTime: 1,
  },
  ...
  // ─── 8. Bond opportunity ──────────────────────────────────
  {
    ...
    action: { label: 'Borçlanma fonlarına bak', tabTarget: 'explorer' },
    timestamp: '2026-05-19',
    readTime: 2,
  },
]
